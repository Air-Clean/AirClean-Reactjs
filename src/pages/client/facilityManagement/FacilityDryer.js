...
function FacilityDryer() {
    ...
    const filteredFacilities = facilityDetail.filter(item => item.facilityDTO.facilityCode === 2);
                    ...
                    <div key={facility.facilityId} className="Facility-washing-machine">
                        ...
                        <div className="Facility-door">
                            <div className="Facility-door-content">
                                ...
                                <div className="Facility-laundry-number">{facility.facilityId}번 건조기</div> {/* 세탁기 번호 */}
