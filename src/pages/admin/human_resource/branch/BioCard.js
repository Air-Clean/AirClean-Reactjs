...
import EmployeeModifyModal from "./BranchModifyModal";
...
export default function BioCard({ branch, setDeleteMember, deleteMember }) {
  ...
  function showBusinessCard() {
    ...
    //             <div class="name">${branch.memberDTO.memberName}</div>
    //             <div class="handle">${branch.employeePosition}</div>
    //             <div class="contact-info">
    //                 <div>${branch.employeeDept}</div>
    //                 <div>${branch.memberDTO.memberId}</div>
    //                 <hr>
    //                 <div>${phone}</div>
    //                 <div>${branch.memberDTO.memberEmail}</div>
    //                 <div>${branch.memberDTO.memberAddress}</div>
    //             </div>
    ...
    return (
      <Grid item xs={6} sm={6} mg={4} lg={3} className="bio_card">
        ...
        <EmployeeModifyModal modal={modal} toggle={toggle} branch={branch} />
      </Grid>
    );
  }
